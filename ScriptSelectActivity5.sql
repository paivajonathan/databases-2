...
-- c)
select nome, valor_unit from produto;
...
-- i)
select * from vendas where data > '2013-06-12' and data < '2013-06-15';

-- j)
select * from vendas where vendedor = 2;

-- k)
select * from vendas where comprador = 1;

-- l)
select * from itens_venda where num_venda = 3;
...
-- r)
select * from vendas order by vendedor desc;
